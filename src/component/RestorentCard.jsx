...
const RestorentCard = ({ resData }) => {
  ...
  return (
    <div className="card-container flex-1 hover:shadow-lg ease-in-out rounded-2xl overflow-hidden min-w-[250px] md:max-w-[250px] cursor-pointer h-auto shadow-md jus mx-2.5">
